...
document.getElementById("messages").innerHTML += '<span>' + topic + ' 측정 중입니다~</span><br/>';
...
function publish(topic, msg) {
    ...
    document.getElementById("messages").innerHTML += '<span>' + topic + ' 측정 중지!</span><br/>';
    ...
    // 도착한 메시지 출력
    if(msg.destinationName == "학생") {
        document.getElementById("topicName").innerHTML = '<span>' + msg.destinationName + '</span>';
        document.getElementById("message").innerHTML = '<span>' + msg.payloadString + '</span>';
    }
    else if (msg.destinationName == "Temp"){
        document.getElementById("messageTemp").innerHTML = '<span>' + msg.payloadString + '</span>';
		addChartData(msg.destinationName, parseFloat(msg.payloadString));
    }
    else if (msg.destinationName == "Humd"){
        document.getElementById("messageHumd").innerHTML = '<span>' + msg.payloadString + '</span>';
